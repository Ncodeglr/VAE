...
class GenerationExperiment(BaseExperiment):
    ...
    def visualize(self) -> None:
        ...
        model=self.model, prob_predictor=self.predictor, dataloader=eval_loader, num_samples=5, mode="lerp", device=self.device
        )
        ...
        outputs, _, _, _ = sample_from_model_distribution(model=self.model, 
